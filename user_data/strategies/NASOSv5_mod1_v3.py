...
class NASOSv5_mod1_v3(IStrategy):
    INTERFACE_VERSION = 3
...
class NASOSv5HO(NASOSv5_mod1_v3):
    # Buy hyperspace params:
    buy_params = {
...
class NASOSv5PD(NASOSv5_mod1_v3):
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
...
class NASOSv5SL(NASOSv5_mod1_v3):
    sell_params = {
        "pHSL": -0.178,
        "pPF_1": 0.019,
        "pPF_2": 0.065,
